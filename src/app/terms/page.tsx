    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm">Last updated: June 2025 · Governing law: Federal Republic of Nigeria</p>
        </div>

        <div className="bg-white rounded-2xl border border-gray-100 p-8 space-y-8 text-gray-700 leading-relaxed">

          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">1. About TailorNow</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">4. Orders and contracts</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">6. Disputes</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">8. Content and intellectual property</h2>
        ...
        <div className="mt-8 flex gap-4 text-sm text-gray-500">
          <Link href="/privacy" className="hover:text-violet-700 underline">Privacy Policy</Link>
          <Link href="/" className="hover:text-violet-700 underline">Back to home</Link>
        </div>
      </div>
    </div>
  )
